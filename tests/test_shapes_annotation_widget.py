...
def test_shapes_annotation_widget_shapes_selector_can_select_existing_target(
    qtbot,
    sdata_blobs: SpatialData,
) -> None:
    viewer = DummyViewer()
...
def test_shapes_annotation_widget_confirming_target_change_discards_annotation_layer(
    qtbot,
    monkeypatch,
    sdata_blobs: SpatialData,
) -> None:
